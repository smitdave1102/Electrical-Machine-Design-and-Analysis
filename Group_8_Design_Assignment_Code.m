...
% V 1.1
% Responsible: Group_8
% Contact: smitd@student.chalmers.se, marjog@student.chalmers.se and rahulp@student.chalmers.se
...
alpha = 360/(2 * q * 3);
N = N_turn* k_w1 * q * r ; % Nd = Nq = N = N_turn* Kw * q* r
